...
// $idd = mysqli_real_escape_string($connect, 'ID432223');
 ...
 $output = array();  
 $sql = "SELECT * FROM product AS P INNER JOIN hose AS H ON P.HoseType = H.HoseType WHERE P.HoseType=? AND P.Username=?";
...
//   }  
  ...
  if(!mysqli_stmt_prepare($stmt, $sql)){
        ...
        mysqli_stmt_bind_param($stmt, "ss", $hoseType, $id_num);
